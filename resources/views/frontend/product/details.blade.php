    ...
    <div class="container-fluid py-5">
        <div class="row px-xl-5">
            ...
            <div class="col-lg-5 pb-5">
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner border">
                        @foreach ($product_thumbnails as $thumbnail )
                        <div class="carousel-item active">

                            <img class="w-100 h-100" src="{{ asset($thumbnail->product_thumbnails ) }}" alt="Image">

                        </div>
                        @endforeach
                        {{-- <div class="carousel-item active">
                            <img class="w-100 h-100" src="{{ asset('frontend/assets/img/product-1.jpg') }}" alt="Image">
                        </div>
            ...
            <div class="col-lg-7 pb-5">
                <h3 class="font-weight-semi-bold">{{ $product_details->product_name }}</h3>
